 ...
 */
final class Version20210220181437 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE entree DROP article_id, CHANGE montant_ht montant_ht INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE entree ADD article_id INT DEFAULT NULL, CHANGE montant_ht montant_ht INT DEFAULT NULL');
